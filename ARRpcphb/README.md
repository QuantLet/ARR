...
## [<img src="https://github.com/QuantLet/Styleguide-and-Validation-procedure/blob/master/pictures/qloqo.png" alt="Visit QuantNet">](http://quantlet.de/) **ARRpcphb** [<img src="https://github.com/QuantLet/Styleguide-and-Validation-procedure/blob/master/pictures/QN2.png" width="60" alt="Visit QuantNet 2.0">](http://quantlet.de/d3/ia)
...
<img src="ARRpcphb_VWL1.png" width="290" />
<img src="ARRpcphb_VWL2.png" width="290" />
<img src="ARRpcphb_VWL3.png" width="290" />
<img src="ARRpcphb_BWL1.png" width="290" />
<img src="ARRpcphb_BWL1.png" width="290" />
<img src="ARRpcphb_BWL1.png" width="290" />
...
TF        = ismissing(merge(:,{'hb_vwl2013_lw_score','hb_vwl2011_lw_score'}));
z1        = table2array(merge(~any(TF,2),{'hb_vwl2011_lw_score','hb_vwl2013_lw_score'}));
...
axes('Position',ax1.Position+[0.045 0 -0.045 0],...
    ...
    'YColor','none',...
    'Color','none');
TF        = ismissing(merge(:,{'hb_vwl2013_cr_score','hb_vwl2011_cr_score','hb_vwl2010_cr_score'}));
z2        = table2array(merge(~any(TF,2),sort({'hb_vwl2010_cr_score','hb_vwl2011_cr_score','hb_vwl2013_cr_score'})));
...
axes('Position',ax2.Position+[0.045 0 -0.045 0],...
    ...
    'YColor','none',...
    'Color','none');
TF        = ismissing(merge(:,{'hb_vwl2013_u40_score','hb_vwl2011_u40_score','hb_vwl2010_u40_score'}));
z3        = table2array(merge(~any(TF,2),sort({'hb_vwl2013_u40_score','hb_vwl2011_u40_score','hb_vwl2010_u40_score'})));
...
axes('Position',ax6.Position+[0.045 0 -0.045 0],...
    ...
    'YColor','none',...
    'Color','none');
%% %% Saving figure (in the file set in 'path' and names beginning with 'ARR_PCP_HB')
