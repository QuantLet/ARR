...
# ---------------------------------------------------------------------
# Quantlet:     ARRmosagegr
# ---------------------------------------------------------------------
# Description:  Produces the mosaic plot of Top-700 scientists of Handelsblatt (HB), RePEc (RP) and Google Scholar (GS) each one.
# ---------------------------------------------------------------------
# Datafile:     ARRmosagegr.csv
#               - The data set contains the number of researchers of certain age classes who are in HB, RP or GS
# ---------------------------------------------------------------------
# Output:       Mosaic plot ("ARRmosagegr.pdf")
# ---------------------------------------------------------------------
